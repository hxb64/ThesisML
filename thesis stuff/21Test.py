...
small_model = lgb.LGBMRegressor(n_estimators=int(best_num_estimators/1.4))
...
for i in range(num_noise_vectors):
    x_valid_noisy = x_valid_normalized + np.random.normal(0, 0.015, x_valid_normalized.shape)  # Adding Gaussian noise
